...
public interface ElasticFolderRepository extends ElasticsearchRepository<ElasticFolder,String>, CustomElasticFolderRepository {

    List<ElasticFolder> findByFolderName(String name);
